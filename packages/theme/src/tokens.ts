...
/**
 * Spacing — 8pt grid (4px base), step → pixels. The `0.5`/`1.5`/`2.5`/`7`
 * steps are the dense-UI micro-grid (2px base) for Linear-style control
 * internals; the 4px steps are the primary grid.
 */
export const space = {
  0: 0,
  0.5: 2,
