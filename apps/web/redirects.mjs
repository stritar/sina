...
export const docsRedirects = [
  // --- Retired translations (the docs are English-only; old locale URLs 301
  //     to their English equivalents, wildcard destination = same slug) ---
  { source: "/es/docs/:path*", destination: "/docs/:path*" },
  { source: "/zh/docs/:path*", destination: "/docs/:path*" },
  { source: "/fr/docs/:path*", destination: "/docs/:path*" },
  { source: "/de/docs/:path*", destination: "/docs/:path*" },
  { source: "/ja/docs/:path*", destination: "/docs/:path*" },
  { source: "/es/docs", destination: "/docs" },
  { source: "/zh/docs", destination: "/docs" },
  { source: "/fr/docs", destination: "/docs" },
  { source: "/de/docs", destination: "/docs" },
  { source: "/ja/docs", destination: "/docs" },
