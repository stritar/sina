...
// Components under the nav read the route; no Next router exists in vitest.
...
beforeAll(() => {
  // Radix dropdown + dialog measure + capture pointers; jsdom has neither.
...
describe("landing page", () => {
  it("renders the idle page with the fintech story static frame and no axe violations", async () => {
    ...
    expect(screen.getByRole("heading", { level: 1 }).textContent).toContain(
      "AI agents will render anything",
    );
